  ...
  return (
    <PacienteLayout>
      <div className="space-y-6">
        <div className="card">
          <div className="p-6 bg-gradient-to-r from-crisal-primary/10 to-crisal-primary-dark/10 rounded-xl mb-6 border border-crisal-gris">
            <div className="w-16 h-16 bg-gradient-to-br from-crisal-primary to-crisal-primary-dark rounded-full flex items-center justify-center mb-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="p-4 border-2 border-crisal-gris rounded-xl hover:border-crisal-turquesa hover:bg-crisal-turquesa/5 transition-all duration-200">
              <div className="w-12 h-12 bg-gradient-to-br from-crisal-primary to-crisal-primary-dark rounded-xl flex items-center justify-center mb-3">
